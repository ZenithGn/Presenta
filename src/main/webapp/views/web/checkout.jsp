                ...
                <div class="checkout-grid">
                    ...
                    <div class="checkout-left-pane">
                        <div class="payment-methods-box">
                            ...
                            <label class="payment-method-label" style="display: flex; align-items: center; padding: 16px 20px; border: 2px solid #3b82f6; border-radius: 12px; margin-bottom: 15px; cursor: pointer; background: #f0f9ff; transition: all 0.3s ease;">
                                <input type="radio" name="paymentMethod" value="VNPAY" checked style="margin-right: 15px; transform: scale(1.2); cursor: pointer;">
                                
                                <img src="${pageContext.request.contextPath}/assets/images/logo/vnpay.png" alt="VNPay Icon" style="width: 36px; height: 36px; object-fit: contain; margin-right: 12px; border-radius: 4px;">
                                
                                <span style="font-size: 15px; font-weight: 600; color: #1e293b;">VNPay Wallet / Banking</span>
                            </label>
