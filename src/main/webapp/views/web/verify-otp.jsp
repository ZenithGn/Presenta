        ...
        <div class="auth-brand-panel">
            ...
            <ul class="brand-features">
                ...
                <li>
                    ...
                    <span>Xác thực an toàn 2 lớp</span>
                </li>
                <li>
                    <div class="feature-icon">
                        <svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    </div>
                    <span>Kiểm tra hộp thư email của bạn</span>
                </li>
            </ul>
        </div>
        ...
        <div class="auth-form-panel">
            <div class="auth-card">
                <div class="card-header">
                    <h1>Nhập mã OTP</h1>
                    <p>Chúng tôi đã gửi mã xác thực 6 số đến email của bạn</p>
                </div>
                ...
                <p class="otp-hint">Vui lòng kiểm tra email và nhập mã <strong>6 chữ số</strong> bên dưới</p>

                <form action="${pageContext.request.contextPath}/MainController" method="POST" class="auth-form" id="verifyOtpForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" class="form-control otp-input" id="otp" name="otp" placeholder="------" pattern="[0-9]{6}" title="Vui lòng nhập đúng 6 chữ số" maxlength="6" required>
                    ...
                    <button type="submit" class="btn-auth-submit" id="verifyOtpSubmitBtn">
                        Xác nhận mã OTP
                    </button>
                </form>
                ...
                <a href="${pageContext.request.contextPath}/MainController?action=Login" class="btn-back-home" id="cancelOtpBtn">
